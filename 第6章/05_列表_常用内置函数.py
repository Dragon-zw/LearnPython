...
# msg_list = ['北京', '尚硅谷', '你好']
# result = sorted(msg_list) # 从小到大
# print(result)
# # print(msg_list) # 北(21271) 尚(23578) 你(20320)
# # print(ord(msg_list[0][0]), ord(msg_list[1][0]), ord(msg_list[2][0]))
# print(sorted(msg_list, reverse=True)) # 从大到小
...
# result = max(23, 11, 32, 30, 17)
# print(result)

# 4.使用內置的 min 函数，获取容器中的最小值，返回值是：最小值。
