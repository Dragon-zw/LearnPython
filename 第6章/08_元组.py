...
# t2[5] = 300  # 元组不支持项目赋值
# t2[5][2] = 400
# print(t2)  # (28, 67, 21, 67, 11, [100, 200, 400, ('你好', '尚硅谷')])
# t2[5][3][0] = 'hello'  # 元组不支持项目赋值
# TypeError: 'tuple' object does not support item assignment
...
# print(type(result), result)  # <class 'list'> [11, 17, 23, 30, 32] # 进行 sorted 函数返回的是列表 List
# # 若要返回的是元组，则进行强制类型转换即可！
# print(tuple(result))  # (11, 17, 23, 30, 32)
# # 将元祖转换成列表
# result = list(t1)
...
# def demo(*args):
#     print(type(args), args)  # <class 'tuple'> (100, 200, 300)
#     return sum(args)
#
#
