...
# res5 = list({'张三': 75, '李四': 60, '王五': 85}.values())
# res6 = list({'张三': 75, '李四': 60, '王五': 85}.keys())
# res7 = list({'张三': 75, '李四': 60, '王五': 85}.items())
# print(type(res1), res1)
# print(type(res2), res2)
# print(type(res3), res3)
# print(type(res4), res4) # 字典是将所有的 key 键转换到 List 列表
# print(type(res5), res5) # 字典是讲所有的 value 键转换到 List 列表
# print(type(res6), res6) # 字典是讲所有的 key 键转换到 List 列表
...
# res5 = tuple({'张三': 75, '李四': 60, '王五': 85}.values())
# res6 = tuple({'张三': 75, '李四': 60, '王五': 85}.keys())
# res7 = tuple({'张三': 75, '李四': 60, '王五': 85}.items())
# print(type(res1), res1)
# print(type(res2), res2)
# print(type(res3), res3)
# print(type(res4), res4)
# print(type(res5), res5) # 字典是讲所有的 value 键转换到 Tuple 元组
# print(type(res6), res6) # 字典是讲所有的 key 键转换到 Tuple 元组
...
# res5 = set({'张三': 75, '李四': 60, '王五': 85}.values())
# res6 = set({'张三': 75, '李四': 60, '王五': 85}.keys())
# res7 = set({'张三': 75, '李四': 60, '王五': 85}.items())
# print(type(res1), res1)
# print(type(res2), res2)
# print(type(res3), res3)
# print(type(res4), res4)
# print(type(res5), res5) # 字典是讲所有的 value 键转换到 Set 集合
# print(type(res6), res6) # 字典是讲所有的 key 键转换到 Set 集合
...
res5 = str({'张三': 75, '李四': 60, '王五': 85}.values())
res6 = str({'张三': 75, '李四': 60, '王五': 85}.keys())
...
print(type(res3), res3)
print(type(res4), res4)
print(type(res5), res5)  # 字典是讲所有的 value 键转换到 Str 字符串
print(type(res6), res6)  # 字典是讲所有的 key 键转换到 Str 字符串
...
# 将【可迭代对象】转换为字典
# 备注: 交给 dict() 函数的内容必须是键值对才可以，否则就会报错
# res1 = dict(range(8))
# print(res1) # Cannot convert dictionary update sequence element #0 to a sequence
res1 = dict({'张三': 75, '李四': 60, '王五': 85})
res2 = dict([('张三', 75), ('李四', 60), ('王五', 85)])  # 括号里面是列表
res3 = dict((('张三', 75), ('李四', 60), ('王五', 85)))  # 括号里面是元组
res4 = dict({('张三', 75), ('李四', 60), ('王五', 85)})  # 括号里面是集合
print(type(res1), res1)
print(type(res2), res2)
print(type(res3), res3)
print(type(res4), res4)
